...
local function worker()
    local font = "ComicCodeLigatures Nerd Font Regular 10"
    local path_to_icons = HOME .. "/.config/awesome/theme/icons/widgets/battery/"
    ...
    watch([[ bash -c 'acpi -i | grep -v "rate information unavailable"' ]], timeout, function(widget, out)
        ...
        widget.icon:set_image(path_to_icons .. iconBatteryStatus .. "/" .. iconBatteryLevel .. ".png")
    end, icon_widget)
